  ...
  return (
    <ChakraProvider>
      ...
      >
        ...
        <NavbarWeb />
        <Box as="main" paddingBottom={heightFooter}>
          {page}
        </Box>
        <FooterWeb />
      </Box>
        ...
        >
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
            ...
            <Stack align={"flex-start"}>
              ...
              <Link
                href={`${process.env.NEXT_PUBLIC_URL_BASE_API}/documentation/`}
              >
                API References
              </Link>
            </Stack>
        ...
        >
          ...
          >
            ...
            <Stack direction={"row"} spacing={6}>
              <SocialButton
                label={"GitHub"}
                href={"https://github.com/fermenen/lupax"}
              >
                <FaGithub />
              </SocialButton>
              <SocialButton
                label={"Twitter"}
                href={"https://www.twitter.com/lupax_app/"}
              >
                <FaTwitter />
              </SocialButton>
              <SocialButton
                label={"LinkedIn"}
                href={"https://www.linkedin.com/company/lupax-app/"}
              >
                <FaLinkedin />
              </SocialButton>
            </Stack>
    ...
    <Stack direction={"row"} spacing={5}>
      {NAV_ITEMS.map((navItem) => (
        <NextLink key={navItem.label} href={navItem.href ?? "#"} passHref>
          <Button as={"a"} fontSize={"lg"} fontWeight={500} variant={"link"}>
            {navItem.label}
          </Button>
        </NextLink>
      ))}
